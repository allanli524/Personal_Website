...
const about = () => {
    return (
        <div className="about_body">
            ...
            <hr></hr>
            <p style={{fontSize:"8vw", textAlign:"center", margin:"10% 0 10% 0"}}>A little about myself . . .</p>
            ...
            <div className="selfintrop2">
                <hr></hr>
                <p style={{fontSize:"8vw", textAlign:"center", width: "80%"}}>A little more interesting</p>
                <p style={{fontSize:"8vw", textAlign:"center"}}>. . .</p>
                <hr></hr>
                <hr style={{width: "80%", border: "1px rgb(221, 219, 219) solid"}}></hr>
                <div className="pic2">
